...
def smoSimple(dataMatIn, classLabels, C, toler, maxIter):
    ...
    while (iter < maxIter):
        ...
        for i in range(m):
            ...
            # print ('labelMat={0}'.format(labelMat))
            # print('multiply(alphas, labelMat)={0}'.format( multiply(alphas, labelMat))

            # 预测的类别 y = W^T * X[i] + b; 其中因为 w = Σ(1~n) a[n]*lable[n]*x[n]
